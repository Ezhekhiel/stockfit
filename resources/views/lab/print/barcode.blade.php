                    ...
                    @foreach ($item as $row => $a)
                        <div class="col-sm-auto card rounded-0 nopadding text-center" style="border:2px solid black;margin:2px; width:130px">
                            ...
                            <div class="body text-center">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ url('/lab/chemical/scan/'.$a) }}" class="qr-code img-thumbnail img-responsive" style="vertical-align:top height: 3cm;width:3cm" />
                            </div>
                        </div>
                    @endforeach
                </div>
